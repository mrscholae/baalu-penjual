            ...
            html += `
                <div class="form-group text-gray-900">
                    <div class="custom-control custom-checkbox small">
                        <input type="checkbox" name="bahan" value="`+data.id_bahan+`|`+data.nama_bahan+`|`+data.satuan+`|`+data.harga_satuan+`" class="custom-control-input" id="`+data.id_bahan+`">
    ...
    $(document).on("click", ".addProduksiBarang", function(){
        ...
        result.forEach(data => {
            html += `
                <div class="form-group text-gray-900">
                    <div class="custom-control custom-checkbox small">
                        <input type="checkbox" name="barang" value="`+data.id_barang+`|`+data.kode_barang+`|`+data.nama_barang+`" class="custom-control-input" id="barang`+data.id_barang+`">
                        <label class="custom-control-label" for="barang`+data.id_barang+`">`+data.nama_barang+`</label>
                    </div>
                </div>
            `
        });
    ...
    $(document).on("click", ".addProduksiBahan", function(){
        ...
        result.forEach(data => {
            html += `
                <div class="form-group text-gray-900">
                    <div class="custom-control custom-checkbox small">
                        <input type="checkbox" name="produksi_bahan" value="`+data.id_bahan+`|`+data.nama_bahan+`|`+data.satuan+`" class="custom-control-input" id="`+data.id_bahan+`">
                        <label class="custom-control-label" for="`+data.id_bahan+`">`+data.nama_bahan+`</label>
                    </div>
                </div>`
        });
    ...
    function data_edit_barang_produksi(id_produksi){
        ...
        if(result.length != 0){
            result.forEach(data => {
                ...
                <div class="form-group text-gray-900">
                    <div class="custom-control custom-checkbox small">
                        <input type="checkbox" name="barang" value="`+data.id_barang+`|`+data.kode_barang+`|`+data.nama_barang+`" class="custom-control-input" id="`+data.id_barang+`">
